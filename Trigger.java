...
public class Trigger extends Hitbox {
    ...
    public String proximityMessage() {
        ...
        if (id == 12) return "red house sign: add text";
        if (id == 13) return "learning centre sign: add text";
